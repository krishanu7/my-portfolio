      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-b from-primary-500 via-primary-600 to-secondary-500 hover:bg-slate-200 text-white font-bold uppercase"
            >
              Hire Me
            </Link>
            <Link
              href="/images/Krishanu_Resume.pdf"
              download="Krishanu_Resume"
              passHref={true}
